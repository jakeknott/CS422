	...
	class MainClass
	{
		...
		private static void Q1()
		{
			...
			for (int i = 1; i < nums.Length; i++)
			{
				...
				// This is atmost ran once, after they switch this will be true but
				// that number is not in the right spot. You need to run all of this again.
		...
		private static void Q3()
		{
			...
			Console.WriteLine ("Does 4.25 = 4.25? {0}", (f1 == d1).ToString ());
			Console.WriteLine ("Does 1.4 = 1.4? {0}", (f2 == d2).ToString ());
		...
		private static void Q7()
		{
			...
			Console.WriteLine("Q7: {0}, {1}, {2}", method1, null, method3);
		}
		...
		private static void Q8()
		{
			...
			node.Next = new {Value = 10, Next = (object)null};
			node.Value = 10;
